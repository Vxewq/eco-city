...
var require_native = __commonJS({
  "node_modules/rollup/dist/native.js"(exports, module) {
    ...
    var { parse: parse3, parseAsync: parseAsync3, xxhashBase64Url: xxhashBase64Url2, xxhashBase36: xxhashBase362, xxhashBase16: xxhashBase162 } = requireWithFriendlyError(
      existsSync(path2.join(__dirname, localName)) ? localName : `@rollup/rollup-${packageBase}`
    );
    ...
    function throwUnsupportedError(isMusl2) {
      throw new Error(
        `Your current platform "${platform2}${isMusl2 ? " (musl)" : ""}" and architecture "${arch}" combination is not yet supported by the native Rollup build. Please use the WASM build "@rollup/wasm-node" instead.
...
var LocalVariable = class extends Variable {
  ...
  addDeclaration(identifier3, init2) {
...
var Scope = class {
   ...
   */
  addDeclaration(identifier3, context, init2, kind) {
    var _a;
    ...
    if (existingVariable) {
      ...
      if (kind === "var" && existingKind === "var") {
        existingVariable.addDeclaration(identifier3, init2);
        return existingVariable;
      }
      context.error(logRedeclarationError(name), identifier3.start);
    }
    const newVariable = new LocalVariable(identifier3.name, identifier3, init2, context, kind);
    ...
    if (kind === "var") {
      ...
      if (existingVariable) {
        ...
        existingVariable.declarations[0].parent.type === CatchClause) {
          const declaredVariable2 = this.parent.parent.addDeclaration(identifier3, context, UNDEFINED_EXPRESSION, kind);
      ...
      const declaredVariable = this.parent.parent.addDeclaration(identifier3, context, init2, kind);
      declaredVariable.markInitializersForDeoptimization();
      this.addHoistedVariable(name, declaredVariable);
      return declaredVariable;
    }
    return super.addDeclaration(identifier3, context, init2, kind);
  }
};
...
var BlockScope = class extends ChildScope {
  ...
  addDeclaration(identifier3, context, init2, kind) {
    ...
    if (kind === "var") {
      ...
      const declaredVariable = this.parent.addDeclaration(identifier3, context, init2, kind);
      declaredVariable.markInitializersForDeoptimization();
      this.addHoistedVariable(name, declaredVariable);
      return declaredVariable;
    }
...
var ObjectPattern = class extends NodeBase {
  ...
  declare(kind, init2) {
    const variables = [];
    for (const property3 of this.properties) {
      variables.push(...property3.declare(kind, init2));
    }
    return variables;
  }
  deoptimizePath(path2) {
    if (path2.length === 0) {
      for (const property3 of this.properties) {
        property3.deoptimizePath(path2);
      }
    }
  }
  hasEffectsOnInteractionAtPath(_path, interaction, context) {
...
var MetaProperty = class extends NodeBase {
  ...
  getReferencedFileName(outputPluginDriver) {
    ...
    if (name === IMPORT && (metaProperty3 == null ? void 0 : metaProperty3.startsWith(FILE_PREFIX))) {
  ...
  render(code, renderOptions) {
    ...
    if (!replacement) {
      replacement = (_a = importMetaMechanisms[format]) == null ? void 0 : _a.call(importMetaMechanisms, metaProperty3, { chunkId, snippets });
...
var ExportDefaultVariable = class _ExportDefaultVariable extends LocalVariable {
  constructor(name, exportDefaultDeclaration3, context) {
    super(name, exportDefaultDeclaration3, exportDefaultDeclaration3.declaration, context, "other");
    this.hasId = false;
...
var ModuleScope = class extends ChildScope {
  ...
  addDeclaration(identifier3, context, init2, kind) {
    if (this.context.module.importDescriptions.has(identifier3.name)) {
      context.error(logRedeclarationError(identifier3.name), identifier3.start);
    }
    return super.addDeclaration(identifier3, context, init2, kind);
  }
  addExportDefaultDeclaration(name, exportDefaultDeclaration3, context) {
    const variable = new ExportDefaultVariable(name, exportDefaultDeclaration3, context);
...
function getAttributesFromImportExpression(node) {
  ...
  const assertProperty = (_a = options.properties.find((property3) => ATTRIBUTE_KEYWORDS.has(getPropertyKey(property3)))) == null ? void 0 : _a.value;
  if (!assertProperty) {
    return EMPTY_OBJECT;
  }
...
var Module = class _Module {
  ...
  async setSource({ ast, code, customTransformCache, originalCode, originalSourcemap, resolvedIds, sourcemapChain, transformDependencies, transformFiles, ...moduleOptions }) {
    ...
    if (ast) {
      ...
      const astBuffer = await (0, import_native2.parseAsync)(code, false);
      timeStart("generate ast", 3);
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-C4QEVIKM.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-W5LWIZP6.js.map
